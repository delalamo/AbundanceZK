        ...
        <div className="content-container" ref={contentRef}>
          ...
          <section className="footnotes-section">
            ...
            <ol className="footnotes-list">
              ...
              <li id="fn4">Eshak, Floriane and Goupil-Lamy, Anne. <a href="https://doi.org/10.1021/acs.jcim.4c01877">"Advancements in nanobody epitope prediction: A comparative study of AlphaFold2Multimer vs AlphaFold3"</a> JCIM 2025 <a href="#fnref4" title="Jump back to footnote 4 in the text">↩</a></li> {/* Back-link points to main text ref */}
