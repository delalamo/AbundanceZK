    ...
    const ContentComponent = () => {
      ...
      return (
        ...
        <div className="content-container" ref={contentRef}>
          ...
          />
          {/* Changed: Added className, removed numbers, unique ID */}
          <p style={{ textAlign: 'center', fontSize: '0.9em' }}>
              <span style={{ fontStyle: 'italic' }}>Figure from </span><sup className="footnote-ref">[<a href="#fn1" id="fnref1_fig1"></a>]</sup>
          </p>
          ...
          {/* Changed: Added className, removed numbers, unique ID */}
          <p style={{ textAlign: 'center', fontSize: '0.9em' }}>
              <span style={{ fontStyle: 'italic' }}>Figure from </span><sup className="footnote-ref">[<a href="#fn2" id="fnref2_fig2"></a>]</sup>
          </p>
          ...
          {/* Changed: Added className, removed numbers, unique ID */}
          <p style={{ textAlign: 'center', fontSize: '0.9em' }}>
              <span style={{ fontStyle: 'italic' }}>Figure from </span><sup className="footnote-ref">[<a href="#fn6" id="fnref6_fig3"></a>]</sup>
          </p>
          ...
          <section className="footnotes-section">
            ...
            <ol className="footnotes-list">
              {/* Ensure li IDs match hrefs, back-links point to primary ref ID */}
              ...
              <li id="fn6">Kolossváry & Coffey <a href="https://doi.org/10.1101/2025.02.12.638002">"Reinforced molecular dynamics: Physics-infused generative machine learning model explores CRBN activation process"</a> biorxiv 2025 <a href="#fnref6" title="Jump back to footnote 6 in the text">↩</a></li> {/* Back-link points to main text ref */}
